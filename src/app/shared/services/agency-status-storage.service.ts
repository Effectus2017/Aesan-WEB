...
export class AgencyStatusStorageService {
  ...
  // Cache deshabilitado: siempre leer/deshashear desde localStorage
  ...
  setAgencyRestrictedStatus(data: AgencyRestrictedStatusPayload): void {
    ...
    // Cache deshabilitado: no actualizar _cachedStatus / _cachedHashedValue
  }

  /**
   * Obtiene el estado de restricción de la agencia desde localStorage
   * Cache deshabilitado: siempre deshashea desde localStorage
  ...
  clearAgencyRestrictedStatus(): void {
    ...
    // Cache deshabilitado: no hay variables de cache que limpiar
  }
