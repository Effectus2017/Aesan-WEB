...
export class EditPACNASponsorEvaluationComponent implements OnInit, OnDestroy, OnGenericHeaderHandlers, OnGenericEditComponentHandler, OnGenericTableHandler {
  ...
  headerConfig: GenericHeaderConfig = {
    ...
    formGroup: this._formBuilder.group({
      ...
      comments: [null],
      monitor: [null],
      isDayCareHomeId: [null, Validators.required],
      extendedHours: [null],
      servicesOfferedSince: [null, Validators.required],
      boardMeetingsPerYear: [null, [Validators.required, Validators.min(2)]],
      boardMeetsRegularly: [null, Validators.required],
      boardExecutiveAuthority: [[], Validators.required],
