...
// Resolver para la creación de un sitio
export const initialDataSitesAddResolver: ResolveFn<any> = (route: ActivatedRouteSnapshot) => {
  ...
  // Determinar si la agencia tiene PDAM o PACNA
  ...
  return forkJoin([
    ...
    optionSelectionService.getOptionSelectionByOptionKey({
      optionKey:
        'yesNo,typeOfResidential,typeOfApplicant,isActive,community,walkers,services,distributionType,siteType,experience,reviewResult,relationshipType,homeType,participantType,siteLocation',
    }),
    // Types of kitchen
    // Tipos de cocina
...
// Resolver para la edición de un sitio
export const initialDataSitesEditResolver: ResolveFn<any> = (route: ActivatedRouteSnapshot) => {
