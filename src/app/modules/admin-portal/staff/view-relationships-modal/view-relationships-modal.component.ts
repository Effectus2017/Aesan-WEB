...
@Component({
  selector: 'app-admin-view-relationships-modal',
...
export class AdminViewRelationshipsModalComponent implements OnInit, OnDestroy {
  ...
  constructor(
    public dialogRef: MatDialogRef<AdminViewRelationshipsModalComponent>,
