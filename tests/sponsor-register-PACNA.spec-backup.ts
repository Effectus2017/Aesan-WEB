...
test.describe('Sponsor Registration - PACNA Program Tests', () => {
  ...
  test('should validate all required fields are present', async ({ page }) => {
    ...
    const requiredFields = [
      ...
      { selector: '[data-cy=uie-input]', name: 'Identificador Único de Entidad (IUE)' },
    ...
    const conditionalFields = [
      ...
      { selector: '[data-cy=is-day-care-home-input]', name: 'Entidad Auspiciadora de Hogares', condition: 'Solo visible para programa PACNA' }
    ];
